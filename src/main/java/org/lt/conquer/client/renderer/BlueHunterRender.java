...
public class BlueHunterRender<Type extends AbstractHunter> extends MobRenderer<Type, HunterModel<Type>>
{
    protected static final ResourceLocation TEXTURE =
            new ResourceLocation(Conquer.MOD_ID, "textures/entities/hunter/steve_blue_png.png");

    public BlueHunterRender(EntityRendererProvider.Context context)
    {
