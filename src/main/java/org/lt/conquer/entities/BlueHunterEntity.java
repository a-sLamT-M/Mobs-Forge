...
public class BlueHunterEntity extends AbstractHunter implements Hunter
{
    private static final ResourceLocation LOOT_TABLE =
            new ResourceLocation(Conquer.MOD_ID, "entities/blue_hunter_entity");

    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID =
            SynchedEntityData.defineId(BlueHunterEntity.class, EntityDataSerializers.BYTE);

    boolean isJohnny;

    public BlueHunterEntity(EntityType<? extends AbstractHunter> p_32105_, Level p_32106_)
    {
    ...
    public void registerGoals()
    {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, RedHunterEntity.class, false, true));
    ...
    {
        double attackDamage = RandomNum.random(3, 1);
    ...
    protected static class HunterOpenDoorGoal extends OpenDoorGoal
    {
        ...
        {
            public HunterAttackGoal(BlueHunterEntity h)
            {
            ...
            {
                return ((BlueHunterEntity) this.mob).isJohnny && super.canUse();
            }
        ...
        {
            public HunterMeleeAttackGoal(BlueHunterEntity blueHunterEntity)
            {
                super(blueHunterEntity, 1.0D, false);
            }
